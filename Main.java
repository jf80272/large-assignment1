...
public class Main {
	public static void main(String[] args) {
        ...
        while(active) {
			...
			System.out.println("16. Get a list of most recently played songs");
			System.out.println("17. Get a list of most frequently played songs");
            System.out.println("18. Create a new user account");
            System.out.println("19. Log in to a pre-existing user account");
            System.out.println("20. Log out of current account");
            System.out.println("21. Exit the program");
